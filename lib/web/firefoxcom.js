...
function () {
  ...
  _createClass(MozL10n, [{
    ...
    value: function getLanguage() {
      return _regenerator["default"].async(function getLanguage$(_context3) {
        while (1) {
    ...
    value: function getDirection() {
      return _regenerator["default"].async(function getDirection$(_context4) {
        while (1) {
    ...
    value: function translate(element) {
      return _regenerator["default"].async(function translate$(_context6) {
        while (1) {
