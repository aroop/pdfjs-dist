...
describe('api', function () {
  ...
  describe('Multiple `getDocument` instances', function () {
    ...
    function renderPDF(filename) {
      ...
      return _regenerator["default"].async(function renderPDF$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _regenerator["default"].awrap(loadingTask.promise);

            case 4:
              pdf = _context.sent;
              _context.next = 7;
              return _regenerator["default"].awrap(pdf.getPage(1));
            ...
            case 7:
              ...
              _context.next = 13;
              return _regenerator["default"].awrap(renderTask.promise);
